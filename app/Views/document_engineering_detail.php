                                            ...
                                            <table id="scroll-vertical-datatable" class="table table-bordered nowrap" style="border: 0px;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <!-- <th colspan="8" class="text-center" style="background-color:#9dc9ae">EXTERNAL</th> -->
                                                        <th colspan="4" class="text-center" style="background-color:#b0f5b0"></th>
                                                        <th colspan="4" class="text-center" style="background-color:#a0faca"></th>
                                                        <th rowspan="4" class="text-center" style="background-color: #b0cbf7;">STATUS</th>
